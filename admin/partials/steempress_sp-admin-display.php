...
<div class="wrap">
    ...
    <form method="post" name="cleanup_options" action="options.php">
        ...
        <br/>
        <textarea maxlength="500" type="text" class="regular-text" id="<?php echo $this->plugin_name; ?>-footer" name="<?php echo $this->plugin_name; ?>[footer]"><?php echo htmlspecialchars(($options["footer"] == "" ? "<br /><center><hr/><em>Posted from my blog with <a href='https://wordpress.org/plugins/steempress/'>SteemPress</a> : [%original_link%] </em><hr/></center>" : $options["footer"]), ENT_QUOTES); ?> </textarea>
        <br />
