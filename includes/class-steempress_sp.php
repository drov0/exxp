...
class Steempress_sp {
	...
	private function define_admin_hooks() {
        ...
        $this->loader->add_action( 'post_submitbox_misc_actions', $plugin_admin,'createSteemPublishField' ); // TODO : remove
        $this->loader->add_action( 'post_submitbox_misc_actions', $plugin_admin,'create_update_checkbox' ); // TODO : remove
